...
<div id = 'list_character'>
    <? foreach ($json_obj as $perso){ ?>
        <a href = "index.php?page=quote&type=character&name=<?= $perso["personnage"] ?>">
            <div class = 'card_character'>
                <div class = 'picture_card_character shadow'>
                    <img src = "img/personnages/<?= nomPhoto($perso["personnage"])?>.jpg"/>
                </div>
                <?= $perso["personnage"];?>
            </div>
        </a>
